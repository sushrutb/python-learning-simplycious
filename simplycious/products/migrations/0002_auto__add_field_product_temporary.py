...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.temporary'
        db.add_column('products_product', 'temporary',
                      self.gf('django.db.models.fields.TextField')(default='sushrut'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.temporary'
        db.delete_column('products_product', 'temporary')
    ...
    models = {
        ...
        'products.product': {
            ...
            'temporary': ('django.db.models.fields.TextField', [], {}),
